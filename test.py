...
def test_generate_posts(article, num_posts, key):
    """
    ...
    payload = {"article_text": article, "num_posts": num_posts}
...
def main():
    ...
    # Start two threads for concurrent requests
    t_1 = threading.Thread(target=test_generate_posts, args=(article_1, num_posts, "article_1"))
    t_2 = threading.Thread(target=test_generate_posts, args=(article_2, num_posts, "article_2"))
